...
import type { AdjustmentFilter } from "../types";
...
interface Props {
  ...
  stores: StoreOption[];
  onChange: Dispatch<SetStateAction<AdjustmentFilter>>;
}

export default function AdjustmentFilter({ filter, stores, onChange }: Props) {
  return (
